  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col">
      ...
      <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
        <h1 class="sm:w-2/5 text-white font-medium title-font text-2xl mb-2 sm:mb-0">Meet the Team Behind KubeEst8</h1>
    ...
    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <h2 class="text-xl font-medium title-font text-white mt-5">Brandon Hernandez</h2>
        <p class="text-base leading-relaxed mt-2"> GitHub</p>
        <p class="text-base leading-relaxed mt-2"> Linkedin</p>
      ...
      <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <h2 class="text-xl font-medium title-font text-white mt-5">Erika Wester</h2>
        <p class="text-base leading-relaxed mt-2"> GitHub</p>
        <p class="text-base leading-relaxed mt-2"> Linkedin</p>
      ...
      <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <h2 class="text-xl font-medium title-font text-white mt-5">Patrick Post</h2>
        <p class="text-base leading-relaxed mt-2"> GitHub</p>
        <p class="text-base leading-relaxed mt-2"> Linkedin</p>
        {/* <a class="text-indigo-400 inline-flex items-center mt-3">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
      ...
      <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <h2 class="text-xl font-medium title-font text-white mt-5">Ines Chavez</h2>
        <p class="text-base leading-relaxed mt-2"> GitHub</p>
        <p class="text-base leading-relaxed mt-2"> Linkedin</p>
        {/* <a class="text-indigo-400 inline-flex items-center mt-3">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
